...
def insert_logo(input_gds, logo_gds, output_gds, offset=(0, 0)):
    ...
    # Insert logo
    logo = layout.cell("logo_usb_cdc")
    top.insert(pya.DCellInstArray(logo.cell_index(), pya.DTrans(pya.DTrans.R90, pya.DPoint(offset[0], offset[1]))))
...
if __name__ == "__main__":
    ...
    insert_logo(args.input_gds, args.logo_gds, args.output_gds, offset=(460, 20))
